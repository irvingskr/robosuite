...
if CUDA_VISIBLE_DEVICES != "":
    ...
    if MUJOCO_EGL_DEVICE_ID is not None:
        visible_device_ids = CUDA_VISIBLE_DEVICES.split(",")
        assert MUJOCO_EGL_DEVICE_ID.isdigit() and (
            MUJOCO_EGL_DEVICE_ID in visible_device_ids
        ), "MUJOCO_EGL_DEVICE_ID needs to be set to one of the device ids specified in CUDA_VISIBLE_DEVICES"
